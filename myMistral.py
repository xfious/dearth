...
class MistralAttention(nn.Module):
    ...
    def forward(
        ...
        # TODO: modified, so it can output x_v
        saved_v = value_states
        ...
        if not output_attentions:
            attn_weights = None
        else: # TODO: modified, the output of attn_weights includes saved_v
            attn_weights = (attn_weights, saved_v)            
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                layer_outputs = decoder_layer(
                    ...
                    position_ids=position_ids,
                    past_key_value=past_key_value,
                    output_attentions=output_attentions if idx == self.target_layer_idx else False, # TODO: modified
                    use_cache=use_cache,
                    padding_mask=padding_mask,
                )
            ...
            if use_cache: # TODO: modified
                next_decoder_cache += (layer_outputs[2 if output_attentions and idx == self.target_layer_idx else 1],)

            #if output_attentions: TODO: modified
            if output_attentions and idx == self.target_layer_idx:
